...
def get_injury_reports(
    ...
    injury_rate = (total_injuries / total_clockouts * 100) if total_clockouts > 0 else 0.0
    ...
    report_entries = [
        InjuryReportEntry(
            ...
            safety_signature=report.safety_signature,
...
def get_dealership_injury_summary(
    ...
    start_date = end_date.replace(day=end_date.day - days) if end_date.day > days else end_date.replace(month=end_date.month - 1, day=end_date.day + (31 - days))
